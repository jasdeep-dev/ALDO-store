...
ActiveRecord::Schema[7.1].define(version: 20_240_526_212_431) do
  create_table 'inventories', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[store_id shoe_model_id], name: 'index_inventories_on_store_id_and_shoe_model_id', unique: true
